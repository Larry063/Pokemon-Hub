$(document).ready(function () {
    ...
    function loadNewsFromAPI(page = 1, append = false) {
        ...
        // We fetch 8 articles per page now (3 for carousel, 5 for grid)
        const newsApiUrl = `https://newsapi.org/v2/everything?q=pokemon%20tcg&language=en&pageSize=8&page=${page}&sortBy=publishedAt&apiKey=${newsApiKey}`;
